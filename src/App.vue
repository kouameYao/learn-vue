              ...
              <ul class="nav navbar-nav notika-top-nav">
                  ...
                  >
                    ...
                    <div class="hd-message-info">
                      <a href="#">
                        <div class="hd-message-sn">
                          <div class="hd-message-img">
                            <img src="../public/img/post/1.jpg" alt="" />
                          </div>
                          <div class="hd-mg-ctn">
                            <h3>David Belle</h3>
                            <p>
                      ...
                      <a href="#">
                        <div class="hd-message-sn">
                          <div class="hd-message-img">
                            <img src="../public/img/post/2.jpg" alt="" />
                          </div>
                          <div class="hd-mg-ctn">
                      ...
                      <a href="#">
                        <div class="hd-message-sn">
                          <div class="hd-message-img">
                            <img src="../public/img/post/4.jpg" alt="" />
                          </div>
                          <div class="hd-mg-ctn">
                ...
                <li class="nav-item nc-al">
                  <a
                    ...
                    <div class="ntd-ctn"><span>3</span></div></a
                  >
                  <div
                    role="menu"
                    class="
                ...
                <li class="nav-item">
                  <a
                    ...
                    <div class="spinner4 spinner-4"></div>
                    <div class="ntd-ctn"><span>2</span></div></a
                  >
                  <div
                    role="menu"
            ...
            <div class="mobile-menu">
              <nav id="dropdown">
                <ul class="mobile-menu-nav">
                  ...
                  <li>
                    <a data-toggle="collapse" data-target="#demolibra" href="#"
                      >Charts</a
                    >
                  ...
                  <li>
                    <a data-toggle="collapse" data-target="#demodepart" href="#"
                      >Tables</a
                    >
            ...
            <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
              ...
              <li>
                <a data-toggle="tab" href="#mailbox"
                  ><i class="notika-icon notika-mail"></i> Email</a
                >
              </li>
              <li>
                <a data-toggle="tab" href="#Interface"
                  ><i class="notika-icon notika-edit"></i> Interface</a
                >
              </li>
              <li>
                <a data-toggle="tab" href="#Charts"
                  ><i class="notika-icon notika-bar-chart"></i> Charts</a
                >
              </li>
              <li>
                <a data-toggle="tab" href="#Tables"
                  ><i class="notika-icon notika-windows"></i> Tables</a
                >
              </li>
              <li>
                <a data-toggle="tab" href="#Forms"
                  ><i class="notika-icon notika-form"></i> Forms</a
                >
              </li>
              <li>
                <a data-toggle="tab" href="#Appviews"
                  ><i class="notika-icon notika-app"></i> App views</a
                >
              </li>
              <li>
                <a data-toggle="tab" href="#Page"
                  ><i class="notika-icon notika-support"></i> Pages</a
                >
              </li>
            </ul>
